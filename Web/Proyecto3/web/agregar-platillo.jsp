...
<body>
    ...
    <div>
        <div class="container" id="info">
            <div>
                <h2 style="text-align: left" class="blue-grey-text text-lighten-2">Nuevo Platillo</h2>
            </div>
        </div>
            <div class="row">
                <form class="col s8"  method="POST" action="./addplatillo.jsp">
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <input id="password" name="descripcion" type="text" class="validate">
                            <label for="last_name">Descripcion</label>
                            <!--input type="submit" value="Registrarse"-->
                        </div>
                        <div class="input-field col s6">
                            <input id="nomb" name="precio" type="number" class="validate">
                            <label for="nomb">Precio</label>
                            <!--input type="submit" value="Registrarse"-->
                        </div>
                        <div class="input-field col s6">
                            <button class="btn waves-effect waves-light blue-grey lighten-2" type="submit" name="action">Agregar
