...
<body>
	...
	<!--fin del navbar-->
        ...
        <div class="container" id="info">
            <div>
                <h2 style="text-align: left" class="blue-grey-text text-lighten-2">Realiza tu pedido</h2>
            </div>
        </div>
        ...
        <div class="row">
                <form class="col s6 " method="POST" action="addpedido.jsp">
                    <div class="row">
                        <div class="input-field col s6">
                            <input  id="first_name" name="platillo" type="number" class="validate">
                            <label for="first_name">Ingresa la clave del platillo: </label>
                        </div>
                        <div class="input-field col s6">
                            <!--a class="waves-effect waves-light btn blue-grey lighten-2" type="submit" >Acceder</a-->
                            <button class="btn waves-effect waves-light blue-grey lighten-2" type="submit" name="action">Pedir</button>
                        </div>
                    </div>
                </form>
            </div>
